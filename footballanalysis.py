...
with row0_1:
    st.title('Football analysis website')
with row0_2:
    st.text("")
    st.subheader('Football analysis website by [Jianyang Hu](https://github.com/JianyangHu)')
row3_spacer1, row3_1, row3_spacer2 = st.columns((.1, 3.2, .1))
with row3_1:
    st.markdown("This interactive application containing Bundesliga data from season 2013/2014 to season 2019/2020 ")
...
all_teams_selected = st.sidebar.selectbox('Do you want to only include specifStreamlit App by Tim Denzleric teams? If the answer is yes, please check the box below and then select the team(s) in the new field.', ['Include all available teams','Select teams manually (choose below)'])
if all_teams_selected == 'Select teams manually (choose below)':
